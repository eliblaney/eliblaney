...
<div id="support" class="scrollspy-section container-fluid">
	...
	<div class="content center">
		...
		<div class="support">
			<img src="{{ asset('images/support/php.png') }}" /><span class="caption">PHP</span>
		</div>
		<div class="support">
			<img src="{{ asset('images/support/node.png') }}" /><span class="caption">NodeJS</span>
		</div>
		<div class="support">
			<img src="{{ asset('images/support/joomla.png') }}" /><span class="caption">Joomla!</span>
		</div>
		<div class="support">
			<img src="{{ asset('images/support/wordpress.png') }}" /><span class="caption">WordPress</span>
		</div>
		<div class="support">
			<img src="{{ asset('images/support/mysql.png') }}" /><span class="caption">MySQL</span>
		</div>
		<div class="support">
			<img src="{{ asset('images/support/django.png') }}" /><span class="caption">Django</span>
		</div>
		<div class="support">
			<img src="{{ asset('images/support/laravel.png') }}" /><span class="caption">Laravel</span>
		</div>
		</div>
